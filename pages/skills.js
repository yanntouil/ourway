            ...
            <Section id="frontend">
                <div className="flex flex-col justify-center w-full max-w-7xl py-16 px-4 sm:px-8 lg:px-16 mx-auto" style={{minHeight: 'calc(100vh - 3rem)'}}>
                    ...
                    <div className="flex flex-col sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:grid-rows-6 lg:grid-rows-4 w-full max-w-7xl mx-auto py-8 gap-8">
                        ...
                        {/* Main content */}
                        <div className="relative col-span-2 row-span-4 order-3 lg:order-2 aspect-square">
                            <Image src={frontendImg} layout="fill" objectFit="cover" priority={true} alt="Laptop" />
                            <div className="absolute inset-0 flex flex-col justify-end p-8  text-white bg-secondary-900/90">
                                <h3 className="text-xl font-semibold">{__('frontend.js.title')}</h3>
                                <Markdown className="flex flex-col gap-2 text-md font-medium leading-relaxed" noProse>{__('frontend.js.content-md')}</Markdown>
                            </div>
                        </div>
                        {/* ... */}
