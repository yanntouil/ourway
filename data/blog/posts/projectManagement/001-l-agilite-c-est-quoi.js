...
1. Accorder de l'importance aux individus et leurs interactions plutôt qu'aux processus et aux outils
    Les équipes deviennent responsables des projets, travaillent de façon solidaire, dynamique, et responsable et tire parti de leurs forces comme de leurs faiblesses, de leurs réussites comme de leurs échecs
2. Accorder de l'importance à un logiciel fonctionnel plutôt qu’à une documentation exhaustive
    Un logiciel est avant tout pragmatique et opérationnel, Il faut privilégier la qualité et la contrôler continuellement, la simplicité et évitant le travail inutile. Les logiciels sont découpés en features fonctionnelles et livrées en permanence.
3. Accorder de l'importance à la collaboration avec les clients plutôt qu'à la négociation contractuelle
    Le client et l'utilisateur sont impliqués dans le développement 
4. Accorder de l'importance à l’adaptation au changement plutôt qu'à l'exécution d’un plan.
    Les projets doivent faire preuves de réactivité face au progrès, à la concurrence, aux attentes du marché , au contexte économique et réglementaire.
...
- **Forming (Formation)**
  Apprendre à se connaitre et à se découvrir au travers d'interaction, le but de cette cohésion d’équipe est de faire ressortir les leaders, les followers et les haters mais aussi d'établir des connexions émotionnelles.
- **Storming (Tension)**
  La confrontation menant au conflit (divergence d'opinion, guerres d'egos, tolérance comportementale,...), c'est là que le coach ou les compétences en communication des membres permettent de rétablir un équilibre.
- **Norming (Normalisation)**
  La coopération arrive ensuite, les membres s'habituent les uns aux autres et un climat de confiance commence à s'instaurer avec des valeurs communes, un objectif commun.
- **Performing (Exécution)**
  L'équipe est dans la meilleure posture pour être efficace et productive. La gouvernance est claire, les interactions construites et les liens se renforcent.   
- **Adjourning (Dissolution)**
  Le désengagement est souvent la dernière phase lier à une lassitude du mode projet. Cette étape engendre souvent un départ massif (membres soudés) mais peut être prémunie par l'instauration de nouveaux challenges.   
...
- **La transparence**   
  L’équipe et les différentes parties prenantes doivent avoir une vision claire et partagée des informations. Le langage doit être commun, convivial et bienveillant, l'information doit être claire et visuelle.
- **L'inspection**   
  L'équipe doit se consulter quotidiennement pour détecter rapidement les éventuels écarts de l'objectif et le travail à réalisé.
- **L'adaptation**   
